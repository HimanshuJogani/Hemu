...
class CharacterCubit extends Cubit<CharacterState> {
  ...
  final GetCharacterNameUsecase getCharacterByName = sl<GetCharacterNameUsecase>();
  ...
  getCharacterRandomData(String name) async {
    final res = await getCharacterByName.call(NameParams(name: name));
    res.fold((failure) {
      print(failure);
    }, (success) {
      emit(CharacterSuccess(success));
