...
class EmployeeRepositoryImpl extends EmployeeRepository {
  ...
  @override
  Future<Either<Failure, void>?>? addEmployeeEntities(Employee employee) async {
  ...
  Future<Either<Failure, void>?>? deleteEmployeeEntities(
    ...
    final delete =
        await appDatabase.employeeDao.deleteEmployee(employeeDetails);
    return Right(delete);
  }
  ...
  Future<Either<Failure, void>?>? updateEmployeeEntities(
    ...
    final update =
        await appDatabase.employeeDao.updateEmployee(employeeDetails);
    return Right(update);
  }
}
